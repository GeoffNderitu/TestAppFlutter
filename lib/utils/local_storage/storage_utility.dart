...
class MySokoAppLocalStorage {
  static final MySokoAppLocalStorage _instance = MySokoAppLocalStorage._internal();

  factory MySokoAppLocalStorage() {
    return _instance;
  }

  MySokoAppLocalStorage._internal();
